...
println("usage: dt N_particles N_integration_steps N_equilibration_steps log_frequency splitting N_bins potential=PERIODIC|QUADRATIC|DOUBLE_WELL|TILTED_DOUBLE_WELL")
...
simulate!(ps,qs,force,hist,qlims,plims,sim,N_eq)
hist=zeros(Int64,N_bins,N_bins)
