...
double_well_potential(q::Float64,L::Float64,a::Float64=1.0,b::Float64=2.0)=quadratic_potential(q,a)+b*exp(-q^2/2)
minus_d_double_well_potential(q::Float64,L::Float64,a::Float64=1.0,b::Float64=2.0)=minus_d_quadratic_potential(q,a)+b*q*exp(-q^2/2)
