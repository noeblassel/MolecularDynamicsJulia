...
minus_d_pathological_potential(q::Float64,L::Float64)=(8q^3*sin(q^4)*cos(q^4))/(1 + sin(q^4)^2)-(2q)/(1 + q^2)

periodic_potential_2D(qx::Float64,qy::Float64,L::Float64=1.0)=cos(2π*qx/L)+sin(2π*qy/L)
minus_grad_periodic_potential_2D(qx::Float64,qy::Float64,L::Float64=1.0)=[-2π*sin(2π*qx/L)/L,2π*cos(2π*qy/L)/L]
